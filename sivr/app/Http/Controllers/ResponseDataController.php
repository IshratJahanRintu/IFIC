...
class ResponseDataController
{
    ...
    public function successCodeGenerate($response , $data)
    {

        $this->errorCode = 1002;
        $this->message = 'Auth Link Generate  Successfully.';
        return $this->responseChannelJsonData($response, 200, $data);
    }
    ...
    public function successLogoutResponse($response)
    {
        $this->errorCode = 1006;
    ...
    public function failedLogoutResponse($response)
    {
        $this->errorCode = 1007;
        $this->message = 'Log Out Data Failed To Update.';
        return $this->responseJsonData($response, 200);
    }

    public function errorInputRequest($response)
    {
        $this->errorCode = 1008;
        $this->message = 'Error Request Attempt';
        return $this->responseJsonData($response, 400);
    }
}
